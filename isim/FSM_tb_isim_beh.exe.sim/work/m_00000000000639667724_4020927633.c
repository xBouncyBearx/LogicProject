...
#endif
static const char *ng0 = "C:/Users/hosse/Desktop/Logic/Parking/FSM.v";
...
static unsigned int ng10[] = {91U, 0U};
...
LAB167:    xsi_set_current_line(102, ng0);
    t4 = (t1 + 4504);
    t5 = (t4 + 56U);
    t6 = *((char **)t5);
    memset(t7, 0, 8);
...
static int sp_BCDto7Segment(char *t1, char *t2)
{
    int t0;
    char *t3;
    char *t4;
...
LAB42:    t5 = ((char*)((ng1)));
    t66 = xsi_vlog_unsigned_case_compare(t4, 4, t5, 4);
    if (t66 == 1)
        goto LAB43;

LAB44:    t2 = ((char*)((ng7)));
    t66 = xsi_vlog_unsigned_case_compare(t4, 4, t2, 4);
    if (t66 == 1)
        goto LAB45;
...
LAB99:    t81 = ((char*)((ng1)));
    t108 = xsi_vlog_unsigned_case_compare(t82, 2, t81, 2);
    if (t108 == 1)
        goto LAB100;

LAB101:    t2 = ((char*)((ng7)));
    t66 = xsi_vlog_unsigned_case_compare(t82, 2, t2, 2);
    if (t66 == 1)
        goto LAB102;
...
LAB100:    xsi_set_current_line(72, ng0);
    ...
    t106 = *((char **)t100);
    t107 = ((char*)((ng5)));
    xsi_vlog_generic_get_index_select_value(t84, 32, t86, t106, 2, t107, 32, 1);
    t109 = ((char*)((ng4)));
    memset(t110, 0, 8);
    t111 = (t84 + 4);
    t112 = (t109 + 4);
...
LAB102:    xsi_set_current_line(73, ng0);
    ...
    t24 = *((char **)t23);
    t25 = ((char*)((ng4)));
    xsi_vlog_generic_get_index_select_value(t13, 32, t11, t24, 2, t25, 32, 1);
    t35 = ((char*)((ng4)));
    memset(t17, 0, 8);
    t41 = (t13 + 4);
    t46 = (t35 + 4);
...
LAB117:    xsi_vlogvar_assign_value(t116, t115, 0, *((unsigned int *)t117), 1);
    goto LAB118;
...
LAB126:    xsi_set_current_line(73, ng0);
    ...
    t81 = *((char **)t80);
    t83 = ((char*)((ng4)));
    xsi_vlog_generic_convert_bit_index(t34, t81, 2, t83, 32, 1);
    t85 = (t34 + 4);
    t30 = *((unsigned int *)t85);
    t67 = (!(t30));
    if (t67 == 1)
        goto LAB127;
...
LAB127:    xsi_vlogvar_assign_value(t57, t56, 0, *((unsigned int *)t34), 1);
    goto LAB128;
...
LAB136:    xsi_set_current_line(74, ng0);
    t56 = ((char*)((ng1)));
    t57 = (t0 + 4024);
    t74 = (t0 + 4024);
    t80 = (t74 + 72U);
...
LAB137:    xsi_vlogvar_assign_value(t57, t56, 0, *((unsigned int *)t34), 1);
    goto LAB138;
...
LAB148:    xsi_set_current_line(75, ng0);
    t2 = ((char*)((ng7)));
    t3 = (t0 + 3384);
    xsi_vlogvar_wait_assign_value(t3, t2, 0, 0, 1, 0LL);
    goto LAB145;

LAB147:    xsi_vlogvar_assign_value(t57, t56, 0, *((unsigned int *)t34), 1);
    goto LAB148;
...
extern void work_m_00000000000639667724_4020927633_init()
{
	static char *pe[] = {(void *)Initial_36_0,(void *)Always_44_1,(void *)Always_83_2};
	static char *se[] = {(void *)sp_StateToCapacity,(void *)sp_StateToNextParking,(void *)sp_BCDto7Segment};
	xsi_register_didat("work_m_00000000000639667724_4020927633", "isim/FSM_tb_isim_beh.exe.sim/work/m_00000000000639667724_4020927633.didat");
